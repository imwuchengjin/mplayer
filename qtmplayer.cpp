...
{
    m_fileName = QFileDialog::getOpenFileName(this, "", "/root");
...
{
    // for windows7 vista
    QString common = QString("mplayer -slave -quiet -zoom %1 -wid %2 ") .arg( m_fileName).arg( QString::number(videoWidget->winId(),10));
    // for XP
